...
const Button = (props) => {
    ...
    return (React.createElement("button", Object.assign({}, props, { className: className ? className : `button button-${varient}` }, props, { onClick: onClick, disabled: disabled }), children ? children : 'Button'));
};
...
const Drawer = ({ align = 'left', width, bg, color, className, style, isOpen = true }) => {
    ...
    return React.createElement(React.Fragment, null, isOpen && React.createElement("div", { className: className ? className : `DrawerContainer DrawerContainer-${align}`, style: DrawerStyles, "data-testid": "drawerComoponent" }));
};
...
const NavBar = ({ align = 'top', width, bg, color, style }) => {
    ...
    return React.createElement("div", { className: `NavBarContainer-${align}`, style: navBarStyles, "data-testid": "navbarComponent" });
};
