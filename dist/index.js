...
const Avatar = ({ src, alt, size = 50, className, onClick }) => {
    return (React.createElement("div", { className: className ? className : `avatarContainer `, onClick: onClick }, src ? React.createElement("img", { className: "avatarImage", src: src, alt: alt }) : React.createElement(AvatarIcon, null)));
};
...
const Alert = ({ message, type = 'success', timeout = 5000, isClosable = true, className }) => {
    ...
    const alertBody = (React.createElement("div", null,
        type === 'success' && React.createElement("span", null,
            "This is the Success Alert ",
            message),
        type === 'failure' && React.createElement("span", null,
            "This is the Failure Alert ",
            message),
        type === 'warning' && React.createElement("span", null,
...
const Button = (props) => {
    ...
    if (outline) {
        return (React.createElement("button", Object.assign({ className: className ? className : `outLineButton outLineButton-${outline}`, style: buttonStyles }, props, { onClick: onClick, type: type ? type : 'submit' }), children ? children : 'Button'));
    }
    else {
        return (React.createElement("button", Object.assign({ className: className ? className : 'commonButton', style: buttonStyles }, props, { onClick: onClick, type: type ? type : 'submit' }), children ? children : 'Button'));
    }
};
...
const Drawer = ({ align = 'left', width, bg, color, style, drawerOpen = true }) => {
    ...
    return React.createElement(React.Fragment, null, drawerOpen && React.createElement("div", { className: `DrawerContainer-${align}`, style: DrawerStyles, "data-testid": "drawerComoponent" }));
};
