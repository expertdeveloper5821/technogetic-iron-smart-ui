...
const Button = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        (type === 'button' || type === 'submit' || type === 'reset') && (React.createElement("button", Object.assign({}, props, { type: type, className: `${className || ''} 'button button'-${variant}} ${disabled ? `button_disabled` : ''} ${startIcon ? 'Icon' : ''} ${endIcon ? 'Icon' : ''}`, onClick: onClick, disabled: disabled }),
