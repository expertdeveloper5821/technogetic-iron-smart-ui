...
const Avatar = ({ src, alt, size = 50, style, onClick }) => {
    return (React.createElement("div", { style: { cursor: onClick ? 'pointer' : 'inherit' }, onClick: onClick },
        React.createElement("img", { src: src, alt: alt, style: Object.assign({ width: size, height: size, borderRadius: '50%', objectFit: 'cover' }, style) })));
};
...
const Badge = ({ label, type = 'primary', max, style }) => {
    ...
    return (React.createElement("span", { className: `badge badge-${type}`, style: Object.assign({ borderRadius: '10px' }, style), "data-testid": "tooltip" }, displayLabel));
};
...
const Button = (props) => {
    ...
    if (outline) {
        return (React.createElement("button", Object.assign({ className: `outLineButton-${outline}` }, props, { onClick: onClick, type: type ? type : 'submit' }), children ? children : 'Button'));
    }
    else {
...
const Drawer = ({ drawerData, openDrawer = false }) => {
    React.useState(openDrawer || false);
    ...
    return (React.createElement(React.Fragment, null, openDrawer && (React.createElement(BrowserRouter, null,
        React.createElement("div", { className: "drawer" }, drawerData.map((data) => {
            return (React.createElement(NavLink, { to: data.link, key: data.id },
                React.createElement("div", { className: `drawerItem ${curr === data.id ? 'active' : ''}`, onClick: () => {
                ...
                curr === data.id &&
                    ...
                    (data === null || data === void 0 ? void 0 : data.items.map((subItem) => {
                        return (React.createElement(NavLink, { to: subItem.link, key: subItem.id },
                            React.createElement("a", { href: subItem.link, onClick: () => {
...
const HorizontalLine = () => {
    return (React.createElement("svg", { width: "29", height: "20", viewBox: "0 0 29 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { d: "M0.0244141 19.8049H28.561V16.6342H0.0244141V19.8049ZM0.0244141 11.8781H28.561V8.70735H0.0244141V11.8781ZM0.0244141 0.780518V3.95125H28.561V0.780518H0.0244141Z", fill: "#858585" })));
};

const Setting = () => {
    return (React.createElement("svg", { width: "24", height: "24", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd" },
        React.createElement("path", { id: "time-3-icon", d: "M12 8.666c-1.838 0-3.333 1.496-3.333 3.334s1.495 3.333 3.333 3.333 3.333-1.495 3.333-3.333-1.495-3.334-3.333-3.334m0 7.667c-2.39 0-4.333-1.943-4.333-4.333s1.943-4.334 4.333-4.334 4.333 1.944 4.333 4.334c0 2.39-1.943 4.333-4.333 4.333m-1.193 6.667h2.386c.379-1.104.668-2.451 2.107-3.05 1.496-.617 2.666.196 3.635.672l1.686-1.688c-.508-1.047-1.266-2.199-.669-3.641.567-1.369 1.739-1.663 3.048-2.099v-2.388c-1.235-.421-2.471-.708-3.047-2.098-.572-1.38.057-2.395.669-3.643l-1.687-1.686c-1.117.547-2.221 1.257-3.642.668-1.374-.571-1.656-1.734-2.1-3.047h-2.386c-.424 1.231-.704 2.468-2.099 3.046-.365.153-.718.226-1.077.226-.843 0-1.539-.392-2.566-.893l-1.687 1.686c.574 1.175 1.251 2.237.669 3.643-.571 1.375-1.734 1.654-3.047 2.098v2.388c1.226.418 2.468.705 3.047 2.098.581 1.403-.075 2.432-.669 3.643l1.687 1.687c1.45-.725 2.355-1.204 3.642-.669 1.378.572 1.655 1.738 2.1 3.047m3.094 1h-3.803c-.681-1.918-.785-2.713-1.773-3.123-1.005-.419-1.731.132-3.466.952l-2.689-2.689c.873-1.837 1.367-2.465.953-3.465-.412-.991-1.192-1.087-3.123-1.773v-3.804c1.906-.678 2.712-.782 3.123-1.773.411-.991-.071-1.613-.953-3.466l2.689-2.688c1.741.828 2.466 1.365 3.465.953.992-.412 1.082-1.185 1.775-3.124h3.802c.682 1.918.788 2.714 1.774 3.123 1.001.416 1.709-.119 3.467-.952l2.687 2.688c-.878 1.847-1.361 2.477-.952 3.465.411.992 1.192 1.087 3.123 1.774v3.805c-1.906.677-2.713.782-3.124 1.773-.403.975.044 1.561.954 3.464l-2.688 2.689c-1.728-.82-2.467-1.37-3.456-.955-.988.41-1.08 1.146-1.785 3.126" })));
};

const Bell = () => {
    return (React.createElement("svg", { width: "22", height: "24", viewBox: "0 0 22 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { d: "M21.3572 19.6178C18.8067 18.466 18.7097 13.5221 18.7078 13.3974V10.0806C18.7078 6.88833 16.7572 4.14334 13.9852 2.97455C13.9792 1.33334 12.6425 0 11.0001 0C9.35762 0 8.02095 1.33341 8.01495 2.97448C5.2431 4.14326 3.29239 6.88825 3.29239 10.0805V13.3973C3.29059 13.522 3.19349 18.466 0.642934 19.6178C0.352385 19.749 0.192698 20.0653 0.259875 20.377C0.326973 20.6887 0.602621 20.9113 0.921484 20.9113H7.38738C7.51993 21.6405 7.86471 22.3189 8.39204 22.8683C9.09244 23.598 10.0187 23.9999 11 23.9999C11.9813 23.9999 12.9076 23.598 13.6079 22.8683C14.1353 22.3188 14.4801 21.6404 14.6126 20.9113H21.0785C21.3973 20.9113 21.6729 20.6887 21.7401 20.377C21.8074 20.0653 21.6478 19.7491 21.3572 19.6178ZM17.9975 17.2494C18.2656 18.0623 18.6452 18.8786 19.1836 19.5579H2.81651C3.35478 18.8787 3.73443 18.0624 4.00255 17.2494H17.9975ZM11.0001 1.35353C11.743 1.35353 12.3712 1.85275 12.5677 2.53322C12.0614 2.4282 11.5371 2.37283 11.0001 2.37283C10.4631 2.37283 9.93879 2.42816 9.43244 2.53322C9.62903 1.85279 10.2572 1.35353 11.0001 1.35353ZM4.64592 13.4014V10.0804C4.64592 6.5768 7.49636 3.72636 11.0001 3.72636C14.5038 3.72636 17.3543 6.5768 17.3543 10.0804V13.407C17.3552 13.5088 17.371 14.5787 17.6406 15.8958H4.35937C4.62918 14.5774 4.6451 13.5056 4.64592 13.4014ZM11.0001 22.6465C9.96711 22.6465 9.06558 21.9017 8.7762 20.9114H13.2239C12.9345 21.9017 12.0331 22.6465 11.0001 22.6465Z", fill: "#858585" })));
};

const NavDown = () => {
    return (React.createElement("svg", { width: "9", height: "5", viewBox: "0 0 9 5", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { d: "M0.0278459 -4.10239e-05L8.93396 0.0556641L4.45305 4.48087L0.0278459 -4.10239e-05Z", fill: "#6C757D" })));
};

const Nav = ({ userData, onClick }) => {
    React.useState(false);
    React.useState(false);
    return (React.createElement("nav", { className: "navContainer" },
        React.createElement("div", { className: "navLeftSide", onClick: (event) => {
                onClick(event, 'Toggle_Button');
            } },
            React.createElement(HorizontalLine, null)),
        React.createElement("div", { className: "navRightSide" },
            React.createElement("div", { className: "settinIcon", onClick: (event) => {
                    onClick(event, 'Setting');
                } },
                React.createElement(Setting, null)),
            React.createElement("div", { className: "bellIcon", onClick: (event) => {
                    onClick(event, 'notification');
                } },
                React.createElement(Bell, null),
                (userData === null || userData === void 0 ? void 0 : userData.notificationCount) && React.createElement("div", { className: "counter" }, userData === null || userData === void 0 ? void 0 : userData.notificationCount)),
            (userData === null || userData === void 0 ? void 0 : userData.avatar) && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "avatarIcon" },
                    React.createElement("img", { src: userData === null || userData === void 0 ? void 0 : userData.avatar, alt: `Avatar of ${userData === null || userData === void 0 ? void 0 : userData.userName}`, width: "57px" })),
                React.createElement("div", { className: "navDownArrow", onClick: (event) => {
                        onClick(event, 'User_Details');
                    } },
                    React.createElement(NavDown, null)))),
            (userData === null || userData === void 0 ? void 0 : userData.userName) && (userData === null || userData === void 0 ? void 0 : userData.designation) && (React.createElement("div", { className: "userDetail" },
                React.createElement("p", { className: "userName" }, userData.userName),
                React.createElement("p", { className: "userDesig" }, userData.designation))))));
};
...
const Menu = ({ menuData, onClick }) => {
    ...
    return (React.createElement(BrowserRouter, null,
        React.createElement("div", { className: "menuContainer" }, menuData.map((menuItem, index) => {
            var _a;
            return (React.createElement(React.Fragment, null,
                React.createElement(NavLink, { to: menuItem.href, key: menuItem.key, className: "menuLink" },
                    ...
                    (menuItem === null || menuItem === void 0 ? void 0 : menuItem.children.map((mapChild) => {
                        return (React.createElement(React.Fragment, null,
                            React.createElement(NavLink, { to: mapChild.href, key: mapChild.key, className: "menuLink" },
                                React.createElement("div", { className: "menuChild", key: mapChild.key, style: { display: subItem ? 'block' : 'none' } }, mapChild.label))));
                    })),
...
const Select = ({ options, placeholder, disabled, name, onChange }) => {
    const selectIconRef = React.useRef(null);
        ...
        React.createElement("div", { className: `SideBarContainer ${align}`, "data-testid": "sidebar-container" },
            React.createElement("div", { className: `${btnOpen ? 'sidebar' : 'slimSideBar'}`, "data-testid": "Sidebar" },
                React.createElement("div", { className: `${btnOpen ? 'top_section' : 'slim_top_section'}` },
                    React.createElement("img", { src: '../../assets/logo2.jpg', alt: "Logo", className: "logo" })),
