...
const Input = (props) => {
    const { className, placeholder, type, adornment, ornament } = props, rest = __rest(props, ["className", "placeholder", "type", "adornment", "ornament"]);
    ...
    return (React.createElement(React.Fragment, null,
        type === 'password' && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `inputField ${className}` },
                React.createElement("input", Object.assign({}, rest, { type: inputType, placeholder: _placeholder })),
        ...
        type !== 'password' && !adornment && !ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `inputField ${className}` },
                React.createElement("input", Object.assign({}, rest, { type: inputType, placeholder: "\u00A0" })),
                React.createElement("span", { className: "togglePlaceholderVisibility" }, placeholder)))),
        type !== 'password' && adornment && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `inputField ${className}` },
                React.createElement("span", { className: "InputAddOn-item" }, adornment),
                React.createElement("input", Object.assign({ className: "InputAddOn-field", placeholder: placeholder }, rest, { type: inputType }))))),
...
const Card = (props) => {
    ...
    const cardHeader = (React.createElement("div", { className: "cardHead" },
        headerImage && React.createElement("img", { src: headerImage, alt: "Card Header Image" }),
