...
const Avatar = ({ name = 'K', src, alt = 'avatar', size = 25, className, onClick }) => {
    ...
    return (React.createElement(React.Fragment, null, src ? (React.createElement("img", { className: className ? className : `avatarImage `, "data-testid": "avatar-container", onClick: onClick, src: src, alt: alt, style: avatarStyle })) : (React.createElement("span", { style: avatarStyle, "data-testid": "avatar-container", onClick: onClick }, getInitials(name)))));
};
...
const Button = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        (type === 'button' || type === 'submit' || type === 'reset') && (React.createElement("button", Object.assign({}, props, { type: "button", className: `${className || ''} button button-${variant} ${disabled ? 'button_disabled' : ''} ${startIcon ? 'Icon' : ''} ${endIcon ? 'Icon' : ''}`, onClick: onClick, disabled: disabled }),
...
const Card = (props) => {
    ...
    return (React.createElement("div", Object.assign({}, props, { className: className ? className : `card noBorderCard ` }),
    ...
    return (React.createElement(React.Fragment, null,
        type === 'password' && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: ` ${className} ${error ? 'error' : ''} commonInputDiv combinedInputField` },
                React.createElement("input", Object.assign({}, rest, { type: inputType, placeholder: _placeholder, autoFocus: autoFocus, disabled: disabled, required: _required, onChange: onChange, "data-testid": "passwordInput" })),
        ...
        type !== 'password' && !adornment && !ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${className} ${error ? 'error' : ''} commonInputDiv` },
                React.createElement("input", Object.assign({ type: _type, placeholder: _placeholder, autoFocus: autoFocus, disabled: disabled, required: _required }, rest, { onChange: onChange, "data-testid": "generalInput" }))))),
        type !== 'password' && adornment && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${className} ${error ? 'error' : ''} combinedInputField` },
                ...
                React.createElement("div", { className: `adornInputField` },
                    React.createElement("input", Object.assign({ className: "InputAddOn-field", placeholder: _placeholder }, rest, { type: _type, autoFocus: autoFocus, disabled: disabled, required: _required, onChange: onChange, "data-testid": "adornmentInput" })))))),
        type !== 'password' && ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${className} ${error ? 'error' : ''}  combinedInputField` },
                React.createElement("div", { className: `oranInputField` },
                    React.createElement("input", Object.assign({ className: "InputAddOn-field", placeholder: _placeholder }, rest, { type: _type, autoFocus: autoFocus, disabled: disabled, required: _required, onChange: onChange, "data-testid": "oranmentInput" }))),
...
const Menu = ({ style, menuData, bg, color, onClick }) => {
    ...
    return (React.createElement(BrowserRouter, null,
        React.createElement("div", { className: "menuContainer", style: menuStyles }, menuData &&
            menuData.map((menuItem, index) => {
                var _a;
                return (React.createElement(React.Fragment, { key: index },
                    (menuItem === null || menuItem === void 0 ? void 0 : menuItem.label) && (React.createElement(NavLink, { to: menuItem.href || '', className: "menuLink" },
                        React.createElement("div", { className: "MenuType" },
                            (menuItem === null || menuItem === void 0 ? void 0 : menuItem.type) !== 'divider' && React.createElement("div", { className: "menuItem_group_title" }, menuItem.type),
                            React.createElement("div", { className: "menuLinkContainer", onClick: () => {
                                    handleSubItem(menuItem.key);
                                }, style: menuStyles },
                                (menuItem === null || menuItem === void 0 ? void 0 : menuItem.icon) && React.createElement("div", { className: "menuImage" }, menuItem.icon),
...
const Popover = ({ content, children, placement, width, height, className, isOpen, setIsOpen }) => {
    ...
    return (React.createElement("div", { style: { position: 'relative' }, className: className },
        React.createElement("div", null, children),
        isOpen && (React.createElement("div", { ref: popoverRef, style: getPopoverStyles() }, content))));
};
...
const Select = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", Object.assign({}, props, { className: "selectContainer", style: containerStyle, onClick: handleSelectOpen, ref: selectRef }),
            selectedValue ? selectedValue : placeholder,
            React.createElement("span", { className: `selctDownIcon ${openSelect ? 'rotateOneEighty' : ''}` },
                React.createElement(DownIcon, null))),
        openSelect && option && (React.createElement("div", { className: "selectItems select", style: optionStyle }, option.map((selectData) => {
...
const Switch = (props) => {
    ...
    return (React.createElement("div", { className: `switch ${className}` },
...
const TableHeader = ({ children }) => {
    return React.createElement("thead", { className: "tableHeader" }, children);
};
...
const NextIcon = () => {
    return (React.createElement("svg", { fill: "#003554", width: "18", height: "14", viewBox: "0 0 24 24", id: "previous", "data-name": "Flat Color", xmlns: "http://www.w3.org/2000/svg", className: "icon flat-color", transform: "rotate(0)matrix(-1, 0, 0, 1, 0, 0)" },
        React.createElement("path", { id: "primary", d: "M17.45,2.11a1,1,0,0,0-1.05.09l-12,9a1,1,0,0,0,0,1.6l12,9a1,1,0,0,0,1.05.09A1,1,0,0,0,18,21V3A1,1,0,0,0,17.45,2.11Z", style: { fill: '#003554' } })));
};

const PreviousIcon = () => {
    return (React.createElement("svg", { fill: "#003554", width: "18", height: "14", viewBox: "0 0 24 24", id: "previous", "data-name": "Flat Color", xmlns: "http://www.w3.org/2000/svg", className: "icon flat-color" },
        React.createElement("path", { id: "primary", d: "M17.45,2.11a1,1,0,0,0-1.05.09l-12,9a1,1,0,0,0,0,1.6l12,9a1,1,0,0,0,1.05.09A1,1,0,0,0,18,21V3A1,1,0,0,0,17.45,2.11Z", style: { fill: '#003554' } })));
};
...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
    ...
    const renderPaginationItem = (page, label) => {
        ...
        return (React.createElement("div", { key: page, className: `pagination-item ${isActive ? 'active' : ''}`, onClick: () => handlePageChange(page) }, label));
    };
    const renderPaginationItems = () => {
        ...
        paginationItems.push(React.createElement("div", { key: "previous", className: `pagination-item ${isFirstPage ? 'disabled' : ''}`, "data-testid": "previousIcon", onClick: () => handlePageChange(currentPage - 1) },
            React.createElement(PreviousIcon, null)));
        // Render the page links
        if (startPage > 1) {
            paginationItems.push(renderPaginationItem(1, 1));
            if (startPage > 2) {
                paginationItems.push(React.createElement("div", { key: "ellipsis-prev", className: "pagination-item ellipsis" }, "..."));
            }
        }
        ...
        if (endPage < totalPages) {
            if (endPage < totalPages - 1) {
                paginationItems.push(React.createElement("div", { key: "ellipsis-next", className: "pagination-item ellipsis" }, "..."));
            }
            paginationItems.push(renderPaginationItem(totalPages, totalPages));
        }
        // Render the next page link
        paginationItems.push(React.createElement("div", { key: "next", className: `pagination-item ${isLastPage ? 'disabled' : ''}`, "data-testid": "nextIcon", onClick: () => handlePageChange(currentPage + 1) },
            React.createElement(NextIcon, null)));
        return paginationItems;
    };
    return React.createElement("div", { className: "pagination" }, renderPaginationItems());
};
