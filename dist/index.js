...
const Button = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        (type === 'button' || type === 'submit' || type === 'reset') && (React.createElement("button", Object.assign({}, props, { type: type, className: `${className ? className : `button button-${variant}`} ${disabled ? `button_disabled` : ''} ${startIcon ? 'Icon' : ''} ${endIcon ? 'Icon' : ''}`, onClick: onClick, disabled: disabled }),
...
const Input = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        type === 'password' && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} commonInputDiv combinedInputField ${className}` },
        ...
        type !== 'password' && !adornment && !ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} commonInputDiv  ${className}` },
        ...
        type !== 'password' && adornment && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} combinedInputField` },
