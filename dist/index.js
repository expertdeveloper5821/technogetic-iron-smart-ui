...
const Button = (props) => {
    ...
    if (outline) {
        return (React.createElement("button", Object.assign({ className: `outLineButton outLineButton-${outline}`, style: buttonStyles }, props, { onClick: onClick, type: type ? type : 'submit' }), children ? children : 'Button'));
    }
    else {
