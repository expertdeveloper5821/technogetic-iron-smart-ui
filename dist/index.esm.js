import React, { useDebugValue, useState, useEffect, useRef, useCallback } from 'react';
...
const Camera = ({ capturing, setCapturing, mediaRecorderRef, recordedChunks, setRecordedChunks, type, cameraType }) => {
    ...
    const capture = useCallback((e) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        e.preventDefault();
    ...
    const handleStartCaptureClick = useCallback((e) => {
        var _a, _b, _c;
        e.preventDefault();
...
const HomePage = ({ sideBarToggle, setSideBarToggle }) => {
    ...
    const [capturelocationData, setCapturelocationData] = useState();
