...
const Sidebar = ({ sidebarData, align, imageSrc, openSideBar }) => {
    const [btnOpen, setBtnOpen] = useState$1(false);
    ...
    return (React__default.createElement(BrowserRouter, null,
        React__default.createElement("div", { className: "SideBarContainer", "data-testid": "sidebar-container" },
            React__default.createElement("div", { className: `${btnOpen ? 'sidebar' : 'slimSideBar'}` },
                    ...
                    return (React__default.createElement(NavLink, { to: item.link, key: item.id },
                        React__default.createElement("div", { className: ` ${btnOpen ? 'SidebarItem' : 'slimSidebarItem'}` },
                            ...
                            React__default.createElement("div", { style: { display: btnOpen ? 'block' : 'none' }, onClick: () => {
                                ...
                                item.name,
                                item.items && ((_a = item.items) === null || _a === void 0 ? void 0 : _a.length) > 0 && React__default.createElement("div", { className: `dropDownIcon ${isOpen && curr === item.id ? 'rotate' : ''}` }, curr === item.id && React__default.createElement(Icon, null)))),
                        curr === item.id &&
                            item.items &&
                            isOpen &&
                ...
                React__default.createElement("div", { className: "footer_section" },
                    React__default.createElement("div", { className: `bars ${btnOpen ? 'rotate' : ''}`, onClick: toggle },
