...
const Input = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        type !== 'password' && !adornment && !ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `inputField ${className}` },
                React.createElement("input", Object.assign({}, rest, { type: inputType, placeholder: placeholder }))))),
        type !== 'password' && adornment && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `inputField ${className}` },
                ...
                React.createElement("input", Object.assign({ className: "InputAddOn-field right", placeholder: placeholder }, rest, { type: inputType }))))),
