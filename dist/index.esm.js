                    ...
                    return (React__default.createElement(NavLink, { to: item.link, key: item.id },
                        React__default.createElement("div", { className: ` ${btnOpen ? 'SidebarItem' : 'slimSidebarItem'}` },
                            ...
                            React__default.createElement("div", { style: { display: btnOpen ? 'block' : 'none' }, onClick: () => {
                                ...
                                item.name,
                                item.items && ((_a = item.items) === null || _a === void 0 ? void 0 : _a.length) > 0 && (React__default.createElement("div", { className: `dropDownIcon ${isOpen && curr === item.id ? 'rotateNintee' : ''}` }, curr === item.id && React__default.createElement(RightArrow, null))))),
                        curr === item.id &&
                            item.items &&
                            isOpen &&
